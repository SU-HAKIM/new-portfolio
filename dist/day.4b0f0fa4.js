...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"day.js":[function(require,module,exports) {
...
form.addEventListener('submit', function (e) {
  ...
  axios.post(url, obj).then(function (res) {
    ...
    tr.id = sin.data.id;
    tr.innerHTML = "\n                    <td class='title'>".concat(sin.data.title, "</td>\n                    <td class='author'>").concat(sin.data.author, "</td>\n                    <td class='isbn'>").concat(sin.data.isbn, "</td>\n                    <td>\n                        <div class=\"btn-group\">\n                            <button class=\"btn btn-primary\" class='edit'>Edit</button>\n                            <button class=\"btn btn-danger\" class='delete'>Delete</button>\n                        </div>\n                    </td>\n                ");
    tbody.appendChild(tr);

    _this.reset();
  }).then(function () {
    requestOnWindowLoad.call(_this);
  });
});
...
window.onload = function (e) {
  ...
  axios.get(url).then(function (res) {
    res.data.forEach(function (sin) {
      var tr = document.createElement('tr');
      tr.id = sin.id;
      tr.className = 'font-weight-bolder';
      tr.innerHTML = "\n                    <td class='title'>".concat(sin.title, "</td>\n                    <td class='author'>").concat(sin.author, "</td>\n                    <td class='isbn'>").concat(sin.isbn, "</td>\n                    <td>\n                        <div class=\"btn-group\">\n                            <button class=\"btn btn-primary\" class='edit'>Edit</button>\n                            <button class=\"btn btn-danger\" class='delete'>Delete</button>\n                        </div>\n                    </td>\n                ");
      tbody.appendChild(tr);
    });
  }).then(function () {
    requestOnWindowLoad.call(_this2);
  }).catch(function (err) {
    console.log(err);
  }).catch(function (err) {
    console.log(err);
...
function requestOnWindowLoad() {
  axios.get(url).then(function (res) {
    var sin = res.data;
    sin.forEach(function (sin) {
      var firstTd = document.getElementById(sin.id);
      var edit = firstTd.querySelector('.btn-primary');
      var del = firstTd.querySelector('.btn-danger');
...
function editData(data, sinId) {
  ...
  var readyTitle = document.querySelector('.title');
  var readyAuthor = document.querySelector('.author');
  var readyIsbn = document.querySelector('.isbn');
  title.value = readyTitle.textContent;
  author.value = readyAuthor.textContent;
  isbn.value = readyIsbn.textContent; // removing data

  var id = data.parentElement.parentElement.parentElement.id;

  if (id == sinId) {
    axios.delete("".concat(url, "/").concat(id)).then(function () {
      _this3.parentElement.parentElement.parentElement.remove();
    }).catch(function (err) {
      console.log(err);
    });
  }
...
function deleteData(data, sinId) {
  ...
  if (id == sinId) {
    axios.delete("".concat(url, "/").concat(id)).then(function () {
      _this4.parentElement.parentElement.parentElement.remove();
    }).catch(function (err) {
      console.log(err);
    });
  }
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","day.js"], null)
//# sourceMappingURL=/day.4b0f0fa4.js.map